    ...
    <div class=" p-5 d-flex justify-content-center">
      <div class="policy-content p-5">
        <div class="tab-content translations-content-item en visible" id="en">
          ...
          <ul>
            <li>
              ...
              "We", "Us" or "Our" in this Cookies Policy) refers to Autafi.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Autafi, accessible from
              <a
                href="https://www.autafi.com/"
                rel="external nofollow noopener"
                target="_blank"
                >https://www.autafi.com</a
              >
            </li>
            <li>
          ...
          <p>
            ...
            web browser.  On occasion, we also use chocolate chip, peanut butter, and oatmeal cookies to power our website.
          </p>
          <p>
        ...
        <div class = "ps-5">
          ...
          <ul>
            <li>By email: peburney@gmail.com</li>
          </ul>
          </div>
        </div>
      </div>
...
width: 12px;
height: 12px;
border: 1px solid rgb(10, 118, 248);;
border-radius: 5px;
}
